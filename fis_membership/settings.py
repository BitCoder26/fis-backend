...
# Volunteers (NM-VO) get their own "activated" template; supporters (NM-SU)
# and paid members keep using BREVO_MEMBERSHIP_ACTIVATED_TEMPLATE_ID above.
BREVO_VOLUNTEER_ACTIVATED_TEMPLATE_ID = int(os.getenv("BREVO_VOLUNTEER_ACTIVATED_TEMPLATE_ID", "0")) or None
